...
!function (e, t) {
  ...
  var r = {
    ...
    append: function append() {
      ...
      for (var r = 0; r < s.length; r += 1) {
        ...
        for (var n = 0; n < this.length; n += 1) {
          ...
          } else if (_instanceof(t, i)) for (var l = 0; l < t.length; l += 1) {
    ...
    prepend: function prepend(t) {
      ...
      for (s = 0; s < this.length; s += 1) {
        ...
        } else if (_instanceof(t, i)) for (a = 0; a < t.length; a += 1) {
  ...
  var n = {
    ...
    extend: function extend() {
      ...
      o = {
    touch: t.Modernizr && !0 === t.Modernizr.touch || !!(t.navigator.maxTouchPoints > 0 || "ontouchstart" in t || t.DocumentTouch && _instanceof(e, t.DocumentTouch)),
  ...
  var ie = {
    ...
    init: function init() {
      var e = this.params.thumbs,
          t = this.constructor;
      _instanceof(e.swiper, t) ? (this.thumbs.swiper = e.swiper, n.extend(this.thumbs.swiper.originalParams, {
        watchSlidesProgress: !0,
        slideToClickedSlide: !1
